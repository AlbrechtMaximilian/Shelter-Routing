...
def evaluate_heuristic_experiment(results_excel_path):
    ...
    sns.boxplot(x='num_shelters', y='rel_improvement_obj', data=df, color='skyblue')
    ...
    plt.figure(figsize=(10, 5))
    sns.boxplot(x='num_shelters', y='rel_improvement_time', data=df, color='lightgreen')
...
if __name__ == "__main__":
    evaluate_heuristic_experiment("heuristic_instances_20250528_134226/experiment_results.xlsx")